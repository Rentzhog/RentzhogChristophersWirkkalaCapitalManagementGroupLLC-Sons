...
},{"./chunks/helpers.segment.cjs":3,"@kurkle/color":1}],5:[function(require,module,exports){
module.exports = require('../dist/helpers.cjs');

},{"../dist/helpers.cjs":4}],6:[function(require,module,exports){
/*!
...
},{"chart.js":2,"chart.js/helpers":5,"hammerjs":7}],7:[function(require,module,exports){
 ...
 */
function get_response(ticker, simulationDate, range, timespan) {
    return __awaiter(this, void 0, void 0, function* () {
        const baseQuery = "https://api.polygon.io/v2/aggs/ticker";
        const query = baseQuery + "/" + ticker + "/range/" + range + "/" + timespan + "/" + simulationDate + "/" + simulationDate + "?apiKey=" + api_key;
        const resultPromise = yield fetch(query).catch((error) => {
...
exports.Bot = void 0;
class Bot {
    constructor(stock, timeline, start_capital) {
        this.account = {
     ...
     * @returns void
     */
    update_stock(time_idx) {
        if (time_idx == 0) {
            return;
        }
        const change = (this.timeline[time_idx].aggregate.close / this.timeline[time_idx - 1].aggregate.close);
     ...
     */
    log_account_status(time_idx) {
        const date = new Date(this.timeline[time_idx].time);
        const change = ((this.account.stock.worth + this.account.capital) / this.start_capital) - 1;
        console.log("");
 ...
 */
function run(date_input, stock_input, capital_input) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log("  RENTZHOG     Capital");
        console.log("CHRISTOPHERS   Management");
        console.log("  WIRKKALA     Group LLC.");
        console.log("                        & Sons");
        const result = yield (0, api_1.get_response)(stock_input, date_input, 1, 'minute');
        const json = JSON.stringify(result);
        const timeline = (0, parse_1.json_to_timeline)(json);
        const bot = new bot_1.Bot(stock_input, timeline, parseInt(capital_input));
        const trade_res = main_loop(bot);
        return trade_res;
    });
}
/**
...
function main_loop(bot) {
    ...
    for (let time_idx = 0; time_idx < bot.timeline.length; time_idx++) {
        ...
        const action = bot.algorithm(time_idx);
...
},{"./api":8,"./bot":9,"./parse":11}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var _a;
Object.defineProperty(exports, "__esModule", { value: true });
const tradingchart_1 = require("./tradingchart");
const main_1 = require("../main");
// Handle form submission
(_a = document.getElementById("simulationForm")) === null || _a === void 0 ? void 0 : _a.addEventListener("submit", function (e) {
    return __awaiter(this, void 0, void 0, function* () {
        e.preventDefault();
        ...
        if (!date || !ticker || !capital)
            return;
        // run the trading bot
        const result = yield (0, main_1.run)(date, ticker, capital);
        // Show results
...
},{"../main":10,"./tradingchart":13}],13:[function(require,module,exports){
"use strict";
...
},{"chart.js":2,"chartjs-plugin-zoom":6}]},{},[12]);
